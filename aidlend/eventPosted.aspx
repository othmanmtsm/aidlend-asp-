<%@ Page Title="" Language="C#" MasterPageFile="~/headerfooter.master" AutoEventWireup="true" CodeFile="eventPosted.aspx.cs" Inherits="eventPosted" %>
            ...
            <div class="banner-item" style="background-image:url('images/hands-poor-poverty-9749.jpg');" > 
                <div class="banner-content">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <h1 class="banner-title">Votre événement a été envoyé à un administrateur pour le vérifier, il sera publié dès qu'un administrateur l'approuve.</h1>
